...
URL: https://medical-llm.preview.emergentagent.com/api/admin/backup/create
```
...
2. اذهب إلى: https://medical-llm.preview.emergentagent.com
3. افتح Developer Tools (F12)
4. Console اكتب:

```javascript
// عرض قائمة النسخ الاحتياطية
fetch('https://medical-llm.preview.emergentagent.com/api/admin/backup/list', {
  headers: {
...
```bash
curl -X POST \
  https://medical-llm.preview.emergentagent.com/api/admin/backup/create \
...
// 2. تحميل نسخة محددة
window.open(
  'https://medical-llm.preview.emergentagent.com/api/admin/backup/download/backup_20241107_020000.json',
  '_blank'
);
```
...
curl -H "Authorization: Bearer ADMIN_TOKEN" \
  https://medical-llm.preview.emergentagent.com/api/admin/backup/download/backup_YYYYMMDD_HHMMSS.json \
  -o backup.json
```
