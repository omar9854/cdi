...
async def create_note(note_data: ClinicalNoteCreate, authorization: str = None):
...
async def get_note(note_id: str, authorization: str = None):
    user = await get_current_user(authorization)
...
async def get_analyses(note_id: str, authorization: str = None):
    user = await get_current_user(authorization)
...
async def export_excel(analysis_id: str, authorization: str = None):
    user = await get_current_user(authorization)
