...
export const translations = {
  ar: {
    ...
    aiAnalysisDescription: 'استخدم الذكاء الاصطناعي لتحليل الملاحظات واستخراج أكواد ICD-10-CM',
    analyzeWithAI: 'تحليل بالذكاء الاصطناعي',
    analyzing: 'جاري التحليل...',
    primaryDiagnoses: 'التشخيصات الرئيسية',
    secondaryDiagnoses: 'التشخيصات الثانوية',
    documentationGaps: 'الثغرات في التوثيق',
    queriesForDoctor: 'استفسارات للطبيب',
    comprehensiveSummary: 'الملخص الشامل',
    exportPDF: 'تصدير PDF',
