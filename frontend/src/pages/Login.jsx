...
import { Lock, Mail, ArrowRight, Activity, Eye, EyeOff, Languages } from 'lucide-react';
...
const Login = ({ setUser }) => {
  ...
  return (
    ...
    >
      {/* Language Toggle Button - Top Right always */}
      <button
        onClick={toggleLanguage}
        className="absolute top-4 right-4 z-30 bg-white/20 backdrop-blur-lg hover:bg-white/30 text-white px-4 py-2 rounded-xl flex items-center gap-2 transition-all duration-300 border border-white/30"
      >
      ...
      {/* Dark Overlay for better readability - gradient from left */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#0a1628]/95 via-[#0a1628]/70 to-transparent z-10" />

      {/* Login Form - Always on LEFT Side */}
      <div className="relative z-20 w-full max-w-md ml-8 lg:ml-16 mr-auto">
        {/* Logo and Title */}
