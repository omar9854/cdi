...
async def main():
    ...
    if admin:
        ...
        await db.login_attempts.delete_many({'email': {'$in': ['almaghthawi.cdi@gmail.com', old_email]}})
        ...
        print(f"   📧 Email: almaghthawi.cdi@gmail.com")
        print(f"   🔑 Password: {new_password}")
    ...
    print("   Email: almaghthawi.cdi@gmail.com")
