...
class VLLMAnalyzeEndpointTester:
    ...
    def get_backend_url(self):
        ...
        # Fallback
        fallback_url = "https://medical-finance-tool.preview.emergentagent.com"
    ...
    def generate_sample_response(self, analysis_data, content_stats):
        ...
        print(f"   First Diagnosis: {sample['first_diagnosis']['diagnosis_en']}")
        print(f"   ICD Code: {sample['first_diagnosis']['icd_code']}")
        print(f"   Total Diagnoses: {sample['analysis_counts']['total_diagnoses']}")
        print(f"   Missing Documentation: {sample['analysis_counts']['missing_documentation']}")
